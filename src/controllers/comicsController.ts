...
const getComicByIdHandler = ( req: Request, res: Response) => {
...
const getAllComicsHandler = ( req: Request, res: Response) => {
...
const deleteComicHandler = (req: Request, res: Response) => {
    try {
        const userId: string = res.locals.jwt.email;
        const id : string = req.params.id;
...
const createComicHandler = (req: Request, res: Response) => {
    try {
        const userId: string = res.locals.jwt.email;
...
const updateComicHandler = (req: Request, res: Response) => {
    try {
        const userId: string = res.locals.jwt.email;
        const id : string = req.params.id;
